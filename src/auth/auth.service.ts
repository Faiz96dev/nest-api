import {Body, HttpException, Injectable, Post, UnauthorizedException} from '@nestjs/common';
...
export class AuthService {
    ...
    private async validateUser(userDto: CreateUserDto) {
        ...
        throw new UnauthorizedException({message: 'Uncorrenct password or email'})
    }
}
